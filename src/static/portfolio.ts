...
export const projects: projectProps[] = [
  ...
  },
  {
    ...
    gitURL: "https://github.com/",
    content:
      "Comprehensive social media platform with real-time messaging, post management, and user interaction features. Includes follow/unfollow functionality, post creation/editing, and personalized timelines.",
    category: "Full Stack",
    thumbnail:
  ...
  },
  {
    ...
    gitURL: "https://github.com/",
    content:
      "Responsive Amazon interface replica with product listings and shopping cart functionality. Implemented state management for seamless user experience across the application.",
    category: "Frontend",
    thumbnail:
